...
EXEC [dbo].[usp_LoyaltyCohort_opt] @indexDate = '20120201', @site='UKY', @lookbackYears=1, @gendered=0, @output=0
EXEC [dbo].[usp_LoyaltyCohort_opt] @indexDate = '20120201', @site='UKY', @lookbackYears=1, @gendered=1, @output=0
EXEC [dbo].[usp_LoyaltyCohort_opt] @indexDate = '20120201', @site='UKY', @lookbackYears=2, @gendered=0, @output=0
EXEC [dbo].[usp_LoyaltyCohort_opt] @indexDate = '20120201', @site='UKY', @lookbackYears=2, @gendered=1, @output=0
EXEC [dbo].[usp_LoyaltyCohort_opt] @indexDate = '20120201', @site='UKY', @lookbackYears=5, @gendered=0, @output=0
EXEC [dbo].[usp_LoyaltyCohort_opt] @indexDate = '20120201', @site='UKY', @lookbackYears=5, @gendered=1, @output=0
EXEC [dbo].[usp_LoyaltyCohort_opt] @indexDate = '20120201', @site='UKY', @lookbackYears=10, @gendered=0, @output=0
EXEC [dbo].[usp_LoyaltyCohort_opt] @indexDate = '20120201', @site='UKY', @lookbackYears=10, @gendered=1, @output=0
