...
BEGIN
  ...
  WHERE CONVERT(DATE,F.START_DATE) BETWEEN DATEADD(YY,-@lookbackYears,CF.INDEX_DT) AND CF.INDEX_DT /* ALTERED OCT2022 - BASE NON-DEMOGRAPHIC FACT LOOKUP ON MEASURE PERIOD */
  EXCEPT
