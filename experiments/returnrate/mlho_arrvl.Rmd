 ...
 * CHANGE mythreshold AROUND LINE 53
...
# NEW 6-23
# Set an output directory, siteid, and threshold cutoff for filtering loyalty after mlearn
currSiteId <- 'MGB'
out_dir <- './'
mythreshold <- .613 # Change to your threshold from the paper: PITT - .321 or UKY- .532 or MGB - .613
