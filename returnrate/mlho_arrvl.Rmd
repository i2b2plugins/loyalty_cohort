...
ggplot(charlson.compare.summary2,aes(y=decile,x=CHARLSON_INDEX,size=log(ct))) + geom_point()
# 10-19-22 Let's save this one too
ggsave(paste0(out_dir,currSiteId,"_charlsoncompare.png"),plot=imp.plot,width=4,height=3,units = "in")
